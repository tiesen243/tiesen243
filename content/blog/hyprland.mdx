...
image: https://github.com/tiesen243/tiesen243/assets/101703006/0bcd2adf-76c7-419a-84f8-d6da2f3334f6
date: 2024-04-10
tags:
  - archlinux
  - hyprland
...
> Remember to disable safe boot in the BIOS settings
...
mkfs.ext4 /dev/[drive_name] # Home partition >= 40GB

# Mount the partitions to the system 
mount --mkdir /dev/[drive_name] /mnt/archinstall # Home partition 
mount --mkdir /dev/[drive_name] /mnt/archinstall/boot # EFI partition

# Run `archinstall` script to start the installation
```

In archinstall script, you can choose the following options:
...
> Remember to config git ssh key
