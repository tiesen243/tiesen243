...
2. If you want to use `api` in `react server component` with protected route, you should pass `headers()` to `headers` option in your api call. This is the example:
